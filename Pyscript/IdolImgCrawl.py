...
class IdolImgCrawlingApp:
    def __init__(self) -> None:
        ...
        self.matchDict = {"뉴진스" : 1, "블랙핑크" : 2, "에스파" : 3, "아이브" : 4}
    ...
    def insertIdol(self):
        ...
        try:
            ...
            insertData = [
                (1, "NewJeans", "https://cdn.clien.net/web/api/file/F01/13174997/2fdb6acdb5ecb3.jpg"),
                (2, "BlackPink", "https://4kwallpapers.com/images/wallpapers/blackpink-pubg-mobile-pink-background-2560x1440-3105.jpg"),
                (3, "AESPA", "https://rare-gallery.com/uploads/posts/340441-Aespa-Kpop-K-pop-Girl-Group-Girls-Members-Karina-Ningning-Giselle-Winter.jpg"),
                (4, "IVE", "https://pbs.twimg.com/media/FFgr7uBVIAAoYYx.jpg:large")
