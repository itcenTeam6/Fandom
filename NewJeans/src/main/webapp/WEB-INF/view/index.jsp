    ...
    <section class="contents">
        ...
        <div class="project">
            ...
            <ul class="animate" data-animate="fadeInUp" data-duration="1s" data-delay="0s">
                <li>
                    <a href="#">
                        <img class="mainIdolImgPo" src="https://pbs.twimg.com/media/FFgr7uBVIAAoYYx.jpg:large" alt="">
                        <div class="name">
                            <span>Website</span>
                ...
                <li>
                    <a href="#">
                        <img class="mainIdolImgPo" src="https://4kwallpapers.com/images/wallpapers/blackpink-pubg-mobile-pink-background-2560x1440-3105.jpg" alt="">
                        <div class="name">
                            <span>Website</span>
                            <h3>HEESUNG LMS</h3>
                        </div>
                ...
                <li>
                    <a href="#">
                        <img class="mainIdolImgPo" src="https://images.chosun.com/resizer/gst8Y76TWvb559SjLSh43AmEUrU=/2000x1333/smart/cloudfront-ap-northeast-1.images.arcpublishing.com/chosun/GO7X3DGRXZDGAPFJJRGNZBR4VI.jpg" alt="">
                        <div class="name">
                            <span>Website</span>
                            <h3>ORPHAN</h3>
                        </div>
                ...
                <li>
                    <a href="#">
                        <img class="mainIdolImgPo" src="https://dbkpop.com/wp-content/uploads/2022/09/le_sserafim_antifragile_teaser_frozen_aquamarine_all_group_2.jpg" alt="">
                        <div class="name">
                            <span>Website</span>
                            <h3>APMA WEB/APP</h3>
                        </div>
